...
DLL_EXPORT_C_DECL void* WINAPI GetTradingDay(CThostFtdcTraderApi *api) { return (void *)api->GetTradingDay(); }
...
DLL_EXPORT_C_DECL void* WINAPI ReqAuthenticate(CThostFtdcTraderApi *api, CThostFtdcReqAuthenticateField *pReqAuthenticateField, int nRequestID) { return (void *)api->ReqAuthenticate(pReqAuthenticateField, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqUserLogin(CThostFtdcTraderApi *api, CThostFtdcReqUserLoginField *pReqUserLoginField, int nRequestID) { return (void *)api->ReqUserLogin(pReqUserLoginField, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqUserLogout(CThostFtdcTraderApi *api, CThostFtdcUserLogoutField *pUserLogout, int nRequestID) { return (void *)api->ReqUserLogout(pUserLogout, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqUserPasswordUpdate(CThostFtdcTraderApi *api, CThostFtdcUserPasswordUpdateField *pUserPasswordUpdate, int nRequestID) { return (void *)api->ReqUserPasswordUpdate(pUserPasswordUpdate, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqTradingAccountPasswordUpdate(CThostFtdcTraderApi *api, CThostFtdcTradingAccountPasswordUpdateField *pTradingAccountPasswordUpdate, int nRequestID) { return (void *)api->ReqTradingAccountPasswordUpdate(pTradingAccountPasswordUpdate, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqOrderInsert(CThostFtdcTraderApi *api, CThostFtdcInputOrderField *pInputOrder, int nRequestID) { return (void *)api->ReqOrderInsert(pInputOrder, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqParkedOrderInsert(CThostFtdcTraderApi *api, CThostFtdcParkedOrderField *pParkedOrder, int nRequestID) { return (void *)api->ReqParkedOrderInsert(pParkedOrder, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqParkedOrderAction(CThostFtdcTraderApi *api, CThostFtdcParkedOrderActionField *pParkedOrderAction, int nRequestID) { return (void *)api->ReqParkedOrderAction(pParkedOrderAction, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqOrderAction(CThostFtdcTraderApi *api, CThostFtdcInputOrderActionField *pInputOrderAction, int nRequestID) { return (void *)api->ReqOrderAction(pInputOrderAction, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQueryMaxOrderVolume(CThostFtdcTraderApi *api, CThostFtdcQueryMaxOrderVolumeField *pQueryMaxOrderVolume, int nRequestID) { return (void *)api->ReqQueryMaxOrderVolume(pQueryMaxOrderVolume, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqSettlementInfoConfirm(CThostFtdcTraderApi *api, CThostFtdcSettlementInfoConfirmField *pSettlementInfoConfirm, int nRequestID) { return (void *)api->ReqSettlementInfoConfirm(pSettlementInfoConfirm, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqRemoveParkedOrder(CThostFtdcTraderApi *api, CThostFtdcRemoveParkedOrderField *pRemoveParkedOrder, int nRequestID) { return (void *)api->ReqRemoveParkedOrder(pRemoveParkedOrder, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqRemoveParkedOrderAction(CThostFtdcTraderApi *api, CThostFtdcRemoveParkedOrderActionField *pRemoveParkedOrderAction, int nRequestID) { return (void *)api->ReqRemoveParkedOrderAction(pRemoveParkedOrderAction, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqExecOrderInsert(CThostFtdcTraderApi *api, CThostFtdcInputExecOrderField *pInputExecOrder, int nRequestID) { return (void *)api->ReqExecOrderInsert(pInputExecOrder, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqExecOrderAction(CThostFtdcTraderApi *api, CThostFtdcInputExecOrderActionField *pInputExecOrderAction, int nRequestID) { return (void *)api->ReqExecOrderAction(pInputExecOrderAction, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqForQuoteInsert(CThostFtdcTraderApi *api, CThostFtdcInputForQuoteField *pInputForQuote, int nRequestID) { return (void *)api->ReqForQuoteInsert(pInputForQuote, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQuoteInsert(CThostFtdcTraderApi *api, CThostFtdcInputQuoteField *pInputQuote, int nRequestID) { return (void *)api->ReqQuoteInsert(pInputQuote, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQuoteAction(CThostFtdcTraderApi *api, CThostFtdcInputQuoteActionField *pInputQuoteAction, int nRequestID) { return (void *)api->ReqQuoteAction(pInputQuoteAction, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqBatchOrderAction(CThostFtdcTraderApi *api, CThostFtdcInputBatchOrderActionField *pInputBatchOrderAction, int nRequestID) { return (void *)api->ReqBatchOrderAction(pInputBatchOrderAction, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqCombActionInsert(CThostFtdcTraderApi *api, CThostFtdcInputCombActionField *pInputCombAction, int nRequestID) { return (void *)api->ReqCombActionInsert(pInputCombAction, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryOrder(CThostFtdcTraderApi *api, CThostFtdcQryOrderField *pQryOrder, int nRequestID) { return (void *)api->ReqQryOrder(pQryOrder, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryTrade(CThostFtdcTraderApi *api, CThostFtdcQryTradeField *pQryTrade, int nRequestID) { return (void *)api->ReqQryTrade(pQryTrade, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryInvestorPosition(CThostFtdcTraderApi *api, CThostFtdcQryInvestorPositionField *pQryInvestorPosition, int nRequestID) { return (void *)api->ReqQryInvestorPosition(pQryInvestorPosition, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryTradingAccount(CThostFtdcTraderApi *api, CThostFtdcQryTradingAccountField *pQryTradingAccount, int nRequestID) { return (void *)api->ReqQryTradingAccount(pQryTradingAccount, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryInvestor(CThostFtdcTraderApi *api, CThostFtdcQryInvestorField *pQryInvestor, int nRequestID) { return (void *)api->ReqQryInvestor(pQryInvestor, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryTradingCode(CThostFtdcTraderApi *api, CThostFtdcQryTradingCodeField *pQryTradingCode, int nRequestID) { return (void *)api->ReqQryTradingCode(pQryTradingCode, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryInstrumentMarginRate(CThostFtdcTraderApi *api, CThostFtdcQryInstrumentMarginRateField *pQryInstrumentMarginRate, int nRequestID) { return (void *)api->ReqQryInstrumentMarginRate(pQryInstrumentMarginRate, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryInstrumentCommissionRate(CThostFtdcTraderApi *api, CThostFtdcQryInstrumentCommissionRateField *pQryInstrumentCommissionRate, int nRequestID) { return (void *)api->ReqQryInstrumentCommissionRate(pQryInstrumentCommissionRate, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryExchange(CThostFtdcTraderApi *api, CThostFtdcQryExchangeField *pQryExchange, int nRequestID) { return (void *)api->ReqQryExchange(pQryExchange, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryProduct(CThostFtdcTraderApi *api, CThostFtdcQryProductField *pQryProduct, int nRequestID) { return (void *)api->ReqQryProduct(pQryProduct, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryInstrument(CThostFtdcTraderApi *api, CThostFtdcQryInstrumentField *pQryInstrument, int nRequestID) { return (void *)api->ReqQryInstrument(pQryInstrument, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryDepthMarketData(CThostFtdcTraderApi *api, CThostFtdcQryDepthMarketDataField *pQryDepthMarketData, int nRequestID) { return (void *)api->ReqQryDepthMarketData(pQryDepthMarketData, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQrySettlementInfo(CThostFtdcTraderApi *api, CThostFtdcQrySettlementInfoField *pQrySettlementInfo, int nRequestID) { return (void *)api->ReqQrySettlementInfo(pQrySettlementInfo, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryTransferBank(CThostFtdcTraderApi *api, CThostFtdcQryTransferBankField *pQryTransferBank, int nRequestID) { return (void *)api->ReqQryTransferBank(pQryTransferBank, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryInvestorPositionDetail(CThostFtdcTraderApi *api, CThostFtdcQryInvestorPositionDetailField *pQryInvestorPositionDetail, int nRequestID) { return (void *)api->ReqQryInvestorPositionDetail(pQryInvestorPositionDetail, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryNotice(CThostFtdcTraderApi *api, CThostFtdcQryNoticeField *pQryNotice, int nRequestID) { return (void *)api->ReqQryNotice(pQryNotice, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQrySettlementInfoConfirm(CThostFtdcTraderApi *api, CThostFtdcQrySettlementInfoConfirmField *pQrySettlementInfoConfirm, int nRequestID) { return (void *)api->ReqQrySettlementInfoConfirm(pQrySettlementInfoConfirm, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryInvestorPositionCombineDetail(CThostFtdcTraderApi *api, CThostFtdcQryInvestorPositionCombineDetailField *pQryInvestorPositionCombineDetail, int nRequestID) { return (void *)api->ReqQryInvestorPositionCombineDetail(pQryInvestorPositionCombineDetail, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryCFMMCTradingAccountKey(CThostFtdcTraderApi *api, CThostFtdcQryCFMMCTradingAccountKeyField *pQryCFMMCTradingAccountKey, int nRequestID) { return (void *)api->ReqQryCFMMCTradingAccountKey(pQryCFMMCTradingAccountKey, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryEWarrantOffset(CThostFtdcTraderApi *api, CThostFtdcQryEWarrantOffsetField *pQryEWarrantOffset, int nRequestID) { return (void *)api->ReqQryEWarrantOffset(pQryEWarrantOffset, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryInvestorProductGroupMargin(CThostFtdcTraderApi *api, CThostFtdcQryInvestorProductGroupMarginField *pQryInvestorProductGroupMargin, int nRequestID) { return (void *)api->ReqQryInvestorProductGroupMargin(pQryInvestorProductGroupMargin, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryExchangeMarginRate(CThostFtdcTraderApi *api, CThostFtdcQryExchangeMarginRateField *pQryExchangeMarginRate, int nRequestID) { return (void *)api->ReqQryExchangeMarginRate(pQryExchangeMarginRate, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryExchangeMarginRateAdjust(CThostFtdcTraderApi *api, CThostFtdcQryExchangeMarginRateAdjustField *pQryExchangeMarginRateAdjust, int nRequestID) { return (void *)api->ReqQryExchangeMarginRateAdjust(pQryExchangeMarginRateAdjust, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryExchangeRate(CThostFtdcTraderApi *api, CThostFtdcQryExchangeRateField *pQryExchangeRate, int nRequestID) { return (void *)api->ReqQryExchangeRate(pQryExchangeRate, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQrySecAgentACIDMap(CThostFtdcTraderApi *api, CThostFtdcQrySecAgentACIDMapField *pQrySecAgentACIDMap, int nRequestID) { return (void *)api->ReqQrySecAgentACIDMap(pQrySecAgentACIDMap, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryProductExchRate(CThostFtdcTraderApi *api, CThostFtdcQryProductExchRateField *pQryProductExchRate, int nRequestID) { return (void *)api->ReqQryProductExchRate(pQryProductExchRate, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryProductGroup(CThostFtdcTraderApi *api, CThostFtdcQryProductGroupField *pQryProductGroup, int nRequestID) { return (void *)api->ReqQryProductGroup(pQryProductGroup, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryMMInstrumentCommissionRate(CThostFtdcTraderApi *api, CThostFtdcQryMMInstrumentCommissionRateField *pQryMMInstrumentCommissionRate, int nRequestID) { return (void *)api->ReqQryMMInstrumentCommissionRate(pQryMMInstrumentCommissionRate, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryMMOptionInstrCommRate(CThostFtdcTraderApi *api, CThostFtdcQryMMOptionInstrCommRateField *pQryMMOptionInstrCommRate, int nRequestID) { return (void *)api->ReqQryMMOptionInstrCommRate(pQryMMOptionInstrCommRate, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryInstrumentOrderCommRate(CThostFtdcTraderApi *api, CThostFtdcQryInstrumentOrderCommRateField *pQryInstrumentOrderCommRate, int nRequestID) { return (void *)api->ReqQryInstrumentOrderCommRate(pQryInstrumentOrderCommRate, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryOptionInstrTradeCost(CThostFtdcTraderApi *api, CThostFtdcQryOptionInstrTradeCostField *pQryOptionInstrTradeCost, int nRequestID) { return (void *)api->ReqQryOptionInstrTradeCost(pQryOptionInstrTradeCost, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryOptionInstrCommRate(CThostFtdcTraderApi *api, CThostFtdcQryOptionInstrCommRateField *pQryOptionInstrCommRate, int nRequestID) { return (void *)api->ReqQryOptionInstrCommRate(pQryOptionInstrCommRate, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryExecOrder(CThostFtdcTraderApi *api, CThostFtdcQryExecOrderField *pQryExecOrder, int nRequestID) { return (void *)api->ReqQryExecOrder(pQryExecOrder, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryForQuote(CThostFtdcTraderApi *api, CThostFtdcQryForQuoteField *pQryForQuote, int nRequestID) { return (void *)api->ReqQryForQuote(pQryForQuote, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryQuote(CThostFtdcTraderApi *api, CThostFtdcQryQuoteField *pQryQuote, int nRequestID) { return (void *)api->ReqQryQuote(pQryQuote, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryCombInstrumentGuard(CThostFtdcTraderApi *api, CThostFtdcQryCombInstrumentGuardField *pQryCombInstrumentGuard, int nRequestID) { return (void *)api->ReqQryCombInstrumentGuard(pQryCombInstrumentGuard, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryCombAction(CThostFtdcTraderApi *api, CThostFtdcQryCombActionField *pQryCombAction, int nRequestID) { return (void *)api->ReqQryCombAction(pQryCombAction, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryTransferSerial(CThostFtdcTraderApi *api, CThostFtdcQryTransferSerialField *pQryTransferSerial, int nRequestID) { return (void *)api->ReqQryTransferSerial(pQryTransferSerial, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryAccountregister(CThostFtdcTraderApi *api, CThostFtdcQryAccountregisterField *pQryAccountregister, int nRequestID) { return (void *)api->ReqQryAccountregister(pQryAccountregister, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryContractBank(CThostFtdcTraderApi *api, CThostFtdcQryContractBankField *pQryContractBank, int nRequestID) { return (void *)api->ReqQryContractBank(pQryContractBank, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryParkedOrder(CThostFtdcTraderApi *api, CThostFtdcQryParkedOrderField *pQryParkedOrder, int nRequestID) { return (void *)api->ReqQryParkedOrder(pQryParkedOrder, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryParkedOrderAction(CThostFtdcTraderApi *api, CThostFtdcQryParkedOrderActionField *pQryParkedOrderAction, int nRequestID) { return (void *)api->ReqQryParkedOrderAction(pQryParkedOrderAction, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryTradingNotice(CThostFtdcTraderApi *api, CThostFtdcQryTradingNoticeField *pQryTradingNotice, int nRequestID) { return (void *)api->ReqQryTradingNotice(pQryTradingNotice, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryBrokerTradingParams(CThostFtdcTraderApi *api, CThostFtdcQryBrokerTradingParamsField *pQryBrokerTradingParams, int nRequestID) { return (void *)api->ReqQryBrokerTradingParams(pQryBrokerTradingParams, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQryBrokerTradingAlgos(CThostFtdcTraderApi *api, CThostFtdcQryBrokerTradingAlgosField *pQryBrokerTradingAlgos, int nRequestID) { return (void *)api->ReqQryBrokerTradingAlgos(pQryBrokerTradingAlgos, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQueryCFMMCTradingAccountToken(CThostFtdcTraderApi *api, CThostFtdcQueryCFMMCTradingAccountTokenField *pQueryCFMMCTradingAccountToken, int nRequestID) { return (void *)api->ReqQueryCFMMCTradingAccountToken(pQueryCFMMCTradingAccountToken, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqFromBankToFutureByFuture(CThostFtdcTraderApi *api, CThostFtdcReqTransferField *pReqTransfer, int nRequestID) { return (void *)api->ReqFromBankToFutureByFuture(pReqTransfer, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqFromFutureToBankByFuture(CThostFtdcTraderApi *api, CThostFtdcReqTransferField *pReqTransfer, int nRequestID) { return (void *)api->ReqFromFutureToBankByFuture(pReqTransfer, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqQueryBankAccountMoneyByFuture(CThostFtdcTraderApi *api, CThostFtdcReqQueryAccountField *pReqQueryAccount, int nRequestID) { return (void *)api->ReqQueryBankAccountMoneyByFuture(pReqQueryAccount, nRequestID); }
