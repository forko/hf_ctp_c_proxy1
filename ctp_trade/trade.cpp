...
DLL_EXPORT_C_DECL void* WINAPI ReqQueryMaxOrderVolume(CThostFtdcTraderApi *api, CThostFtdcQryMaxOrderVolumeField *pQueryMaxOrderVolume, int nRequestID) { return (void *)api->ReqQryMaxOrderVolume(pQueryMaxOrderVolume, nRequestID); }
