...
DLL_EXPORT_C_DECL void* WINAPI GetTradingDay(CThostFtdcMdApi *api) { return (void *)api->GetTradingDay(); }
...
DLL_EXPORT_C_DECL void* WINAPI ReqUserLogin(CThostFtdcMdApi *api, CThostFtdcReqUserLoginField *pReqUserLoginField, int nRequestID) { return (void *)api->ReqUserLogin(pReqUserLoginField, nRequestID); }
DLL_EXPORT_C_DECL void* WINAPI ReqUserLogout(CThostFtdcMdApi *api, CThostFtdcUserLogoutField *pUserLogout, int nRequestID) { return (void *)api->ReqUserLogout(pUserLogout, nRequestID); }
